...
export default function OwnerSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-purple-900 p-4 md:p-6 lg:p-8">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-2 -right-2">
                    <Label
                      ...
                      className="flex items-center justify-center w-8 h-8 bg-purple-500 text-white rounded-full cursor-pointer hover:bg-purple-600 transition-colors"
                    >
