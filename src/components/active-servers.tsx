              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2 text-xs">
                  <div className="text-center p-2 bg-gray-800/50 rounded">
                    ...
                    <div className="text-gray-300">{formatMemory(server.limits?.memory || 0)}</div>
                  </div>
                  <div className="text-center p-2 bg-gray-800/50 rounded">
                    <HardDrive className="w-4 h-4 mx-auto mb-1 text-green-400" />
                    <div className="text-gray-300">{formatMemory(server.limits?.disk || 0)}</div>
                  </div>
                  <div className="text-center p-2 bg-gray-800/50 rounded">
                    <Cpu className="w-4 h-4 mx-auto mb-1 text-yellow-400" />
                    <div className="text-gray-300">{server.limits?.cpu || 0}%</div>
                  </div>
                </div>
